...
from ui.system_health.data import get_system_data
...
def render_system_charts():
    ...
    with left:
        ...
        fig.update_layout(**_layout("CPU Usage Trend"))
        _style_axes(fig)
        _render_chart(fig, "system_cpu_chart")
    ...
    with right:
        ...
        fig.update_layout(**_layout("Memory Usage Trend"))
        _style_axes(fig)
        _render_chart(fig, "system_memory_chart")