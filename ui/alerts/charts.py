...
from ui.alerts.data import get_alert_data
...
def render_alert_charts():
    ...
    with left:
        ...
        fig.update_layout(**_layout("Alert Timeline"))
        _style_axes(fig)
        _render_chart(fig, "alert_timeline_chart")
    ...
    with right:
        ...
        fig.update_layout(**_layout("Alert Severity Distribution"))
        fig.update_layout(showlegend=False, margin=dict(l=10, r=10, t=55, b=10))

        _render_chart(fig, "alert_severity_chart")