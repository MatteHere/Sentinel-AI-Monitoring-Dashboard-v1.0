...
def render_model_charts():
    ...
    with left:
        ...
        fig.update_layout(**_layout("Requests by Model"))
        _style_axes(fig)
        _render_chart(fig, "model_requests_chart")
    ...
    with right:
        ...
        fig.update_layout(**_layout("Average Latency by Model"))
        _style_axes(fig)
        _render_chart(fig, "model_latency_chart")